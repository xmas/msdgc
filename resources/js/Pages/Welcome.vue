...
const navStyle = "text-white font-bold whitespace-nowrap rounded-md px-3 py-2 ring-1 ring-transparent transition hover:text-blue/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white hover:bg-white/10 dark:hover:bg-white/10";
...
<template>
    ...
    <Head title="Welcome" />
    <div class="text-black/50 dark:text-white/50" style="background: linear-gradient(180deg, #3477F4 0%, #ffffff 30%);">
        <img id="background" class="absolute inset-0 w-full h-full object-cover object-center z-0 opacity-40"
            src="images/north_park_hole_1.jpg" />
        <div class="relative min-h-screen flex flex-col items-center selection:bg-[#FF2D20] selection:text-white">
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">

                <header
                    class=" items-center justify-center gap-4 py-4 bg-white/10 dark:bg-zinc-800/10 backdrop-blur-lg rounded-lg px-4 mt-4 ">
                    <div class="text-xl font-bold text-white">
                        Mineral Springs Disc Golf
                    </div>
                    <div class="mt-2 text-white">
                        Seattle's only disc golf course
                    </div>
                </header>

                <header
                    class="flex items-center justify-between gap-4 py-4 bg-white/10 dark:bg-zinc-800/10 backdrop-blur-lg rounded-lg px-4 mt-4">
                    <img src="/images/msdgc.png" alt="MSDGC Logo" class="h-12 w-auto" />
                    <nav class="hidden sm:flex gap-4 lg:col-span-1">
                        <a href="#calendar" :class="navStyle">Calendar</a>
                        <a href="#lost-found" :class="navStyle">Lost and Found</a>
                        <a href="#club-membership" :class="navStyle">Club Membership</a>
                        <a href="#get-involved" :class="navStyle">Get Involved</a>
                    </nav>
