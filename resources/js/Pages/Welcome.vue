                    ...
                    <main class="mt-6">
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div v-if="sponsors.items && sponsors.items.length > 0" class="col-span-full">
                                <h2 class="text-4xl font-bold text-center mb-6 bangers text-gray-800">Our Sponsors</h2>
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                    <div
                                        v-for="sponsor in sponsors.items"
                                        :key="sponsor.id"
                                        :class="cardStyle"
                                    ...
                                    >
                                        <div class="flex flex-col md:flex-row gap-4 items-start">
                                            ...
                                            <div class="flex-shrink-0 w-24 h-24 md:w-32 md:h-32">
                                                <img
                                                    v-if="sponsor.logo && sponsor.logo[0]"
                                                    :src="sponsor.logo[0]"
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <h3 class="text-2xl font-bold mb-2 bangers text-blue-700">{{ sponsor.title }}</h3>
                                                ...
                                                <div class="space-y-2 text-sm">
                                                    ...
                                                    <p v-if="sponsor.city_state" class="flex items-center">
                                                        ...
                                                        <span>{{ sponsor.city_state }} - {{ sponsor.north_of_msdgc ? 'North' : 'South' }} of Mineral Springs</span>
                                                    </p>

                                                    <!-- Nearby description -->
                                                    <p v-if="sponsor.nearby" class="text-gray-700">{{ sponsor.nearby }}</p>

                                                    <!-- Links -->
                                                    <div class="flex flex-wrap gap-2 mt-3">
                                                        <a
                                                            v-if="sponsor.web_site"
                                                            :href="sponsor.web_site"
                                                            target="_blank"
                                                            rel="noopener"
                                                        ...
                                                        <a
                                                            v-if="sponsor.udisc_link"
                                                            :href="sponsor.udisc_link"
                                                            target="_blank"
                                                            rel="noopener"
                                                        ...
                                                        <a
                                                            v-if="sponsor.driving_directions"
                                                            :href="sponsor.driving_directions"
                                                            target="_blank"
                                                            rel="noopener"
